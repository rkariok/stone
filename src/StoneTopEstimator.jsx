...
export default function StoneTopEstimator() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f7fa] flex flex-col items-center justify-center px-4 py-10 text-center space-y-6">
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-2xl space-y-6">
        <div className="flex justify-center">
          <img src="/AIC.jpg" alt="Logo" className="max-h-[100px] w-auto object-contain mx-auto mb-4" />
        </div>
